...
public class CodilityTask {
 ...
 of the respective words Codility, Test and Coders in this given order.
    ...
    public static void main(String[] args) {
        ...
        int number=6;
        //we w'l create a variable in order to put our result in it
        String result="";
        ...
        if (number>0){
            ...
            //if the number is positive we will check the number divisible by 2 we put the codility insode variable
        }else{
